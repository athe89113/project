    ...
    <div>
        <div class="global-wrap">
            <div class="global-head ys-box-con">
                ...
                <div class="global-title m-t-5">
                    <p class="ys-info-color textC">安全态势</p>
                </div>
            </div>
        ...
        <aside :show.sync="showAddUnit" :header="'选择图表'" :left="'auto'" :width="'622px'">
            ...
            <template v-for="item in tabList">
              ...
              <a @click="tabClick($index, item)" :class="{'ys-success-color':$index==tabIndex, 'banClick': this.$route.name != item.id}">{{item.name}}</a>
            </template>
          </span>
                </p>
            </div>
            <div class="box-chart" v-for="item in forTable">
                <div class="ys-box-con Block" @click="selectChart(item,$index)" :class="{on:$index==selectId}">
                    ...
                    <img v-if="item.chart_type=='scatter'" src="../../../assets/images/ssac/scatter.png" alt="">
                    <img v-if="item.chart_type=='loop'" src="../../../assets/images/ssac/pie.png" alt="">
                    <img v-if="item.chart_type=='funnel'" src="../../../assets/images/ssac/funnel.png" alt="">
                </div>
            </div>
            <div class="clear"></div>
...
<script>
    ...
    import globalFullPage from '../global/ssa-global-full.vue'
    ...
    export default {
        ...
        data() {
            return {
                ...
                tabIndex: 2, // 头部索引
                tabList: [ // 头部列表
                    {name: '默认全部',id: 'default'},
                    {name: '资源分析图表',id: 'ssa-source'},
                    {name: '安全分析图表',id: 'ssa-security'}
                ],
                selectCharts: {},
                selectId: null,
                BlockIndex: 0,
...
//                    this.show = !this.show
            ...
            getSortChart(item, index) {
                ...
                this.$http.post('/api/ssa/chart/perview', {
                    ...
                    Vue.set(_this.charts['chart' + item.cell_order], 'datas', data)

        ...
        methods: {
            initChart() {
                ...
                let repeat = setInterval(function () {
                    if (document.getElementById('risk-bubble-chart-' + self.id)) {
                        self.setChart();
                ...
                let resizeRepeat = setInterval(function () {
                    if (document.getElementById('risk-bubble-chart-' + self.id)) {
                        ...
                        var resizeDiv = document.getElementById('risk-bubble-chart-' + self.id);
            ...
            setChart() {
                ...
                if(!document.getElementById('risk-bubble-chart-' + this.id)) return false;
                self.chart = echarts.init(document.getElementById('risk-bubble-chart-' + this.id));
                let option = {
                    roam: false, //鼠标缩放及平移
                    ...
                    tooltip: {
                        ...
                        formatter: function (params) {
                            if(params.seriesName != '2'){
                                return params.data.name + '</br>' + '风险值：' + self.changeWanUnit(params.data.value)
                            }
                        }
                    },
                    series: [{

    ...
    <div class="pos-r m-t-10">
      <div class="box-left" style="margin-right:223px;">
        <div class="ys-box m-t-5">
          <div class="ys-box-title">编辑<!--知识点--></div>
          <div class="ys-box-con">
            <table class="bigTable" :data-sync="submitData">
              <tr>
                <td>知识点名称:</td>
                <td>
  ...
  export default {
    ...
    data () {
      return {
        ...
        "editPort":"/api/op_store/knowledge/detail/",
    ...
    methods:{
      ...
      initDetail:function(){
        this.$http.get(this.detailPort+this.$route.params.id,{}).then(function(response){
          if(Number(response.data.status)===200){
            ...
            this.typeInput={
              "id":this.submitData.type,
              "name":this.submitData.type
            };
            this.sceneInput={
              "id":this.submitData.scene,
              "name":this.submitData.scene
            };
            this.tagInput=this.submitData.tag;
            this.contentHtml=this.submitData.content;
            this.relateHtml=this.submitData.relate;
          }
          else{
      ...
      submitPage:function(){
        ...
        for(let k in this.submitData){
          if(typeof(errInfo[k])!=="undefined"&&this.submitData[k]===""){
            errsLength+=1;
